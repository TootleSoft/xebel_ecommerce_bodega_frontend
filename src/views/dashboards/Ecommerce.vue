...
customerService.value = new CustomerService();
const initChart = async () => {
    ...
    customersTable.value = await customerService.value.getCustomersLarge();
    customersTable.value.forEach((customer) => (customer.date = new Date(customer.date)));

    customersTable1.value = await customerService.value.getCustomersLarge();
    customersTable1.value.forEach((customer) => (customer.date = new Date(customer.date)));

    customersTable2.value = await customerService.value.getCustomersMixed();
...
<template>
    <div class="grid">
        ...
        <div class="col-12 md:col-8">
            <div class="card widget-visitor-graph">
                <div class="card-header line-height-4">
                    ...
                    <Dropdown :options="visitorYear" v-model="selectedVisitorYear" optionLabel="name" @change="changeVisitorChart($event)"></Dropdown>
                </div>

                <div class="graph-content grid mt-4">
                    <div class="col-12 md:col-6">
                        <h2>{{ growth }}</h2>
                        <h6 class="mt-3">MRR GROWTH</h6>
                        <p class="text-color-secondary">Measure how fast you’re growing mothly recurring revenue. <a href="#" class="text-primary hover:text-primary-400 transition-duration-200">Learn more</a></p>
                    </div>
                    <div class="col-12 md:col-6">
                        <h2>{{ avgCustomer }}</h2>
                        <h6 class="mt-3">AVG. MRR/CUSTOMER</h6>
                        <p class="text-color-secondary">The revenue generated per account on a monthly or yearly basis. <a href="#" class="text-primary hover:text-primary-400 transition-duration-200">Learn more</a></p>
                    </div>
                </div>

                <div class="graph">
                    <h6 class="mt-4">Revenue</h6>
        ...
        <div class="col-12 md:col-4">
            <div class="card p-0">
                ...
                <div class="timeline-footer border-top-1 surface-border p-3 flex align-items-center justify-content-center">
                    <a href="#" class="text-primary hover:text-primary-400 transition-duration-200">View all transactions<i class="pi pi-arrow-down"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 md:col-4">
            <div class="card">
                <div class="font-medium line-height-4">Country distrubutions</div>
                <div class="country-graph">
                    <div class="flex justify-content-center">
                        <Chart type="doughnut" :height="345" :data="countryChart" :options="countryChartOptions" class="w-9" id="country-chart"></Chart>
                    </div>
                </div>
                <div class="country-content">
                    <ul class="m-0 p-0 border-none outline-none list-none">
                        <li class="flex justify-content-between align-items-center py-2 border-bottom-1 surface-border">
                            <div class="flex justify-content-between align-items-center">
                                <div class="w-2rem h-2rem border-round mr-2" style="background-color: var(--cyan-400); box-shadow: 0px 0px 10px rgba(0, 208, 222, 0.3)"></div>
                        ...
                        <li class="flex justify-content-between align-items-center py-2 border-bottom-1 surface-border">
                            <div class="flex justify-content-between align-items-center">
                                <div class="w-2rem h-2rem border-round mr-2" style="background-color: var(--purple-400); box-shadow: 0px 0px 10px rgba(135, 62, 254, 0.3)"></div>
                                <span>China</span>
                            </div>
                            <span>20%</span>
                        </li>
                        <li class="flex justify-content-between align-items-center py-2 border-bottom-1 surface-border">
                            <div class="flex justify-content-between align-items-center">
                                <div class="w-2rem h-2rem border-round mr-2" style="background-color: var(--red-400); box-shadow: 0px 0px 10px rgba(252, 97, 97, 0.3)"></div>
                                <span>Japan</span>
                            </div>
                            <span>17%</span>
                        </li>
                        <li class="flex justify-content-between align-items-center py-2 border-bottom-1 surface-border">
                            <div class="flex justify-content-between align-items-center">
                                <div class="w-2rem h-2rem border-round mr-2" style="background-color: var(--yellow-400); box-shadow: 0px 0px 10px rgba(238, 229, 0, 0.3)"></div>
                                <span>Australia</span>
                            </div>
                            <span>15%</span>
                        </li>
                        <li class="flex justify-content-between align-items-center py-2 border-bottom-1 surface-border">
                            <div class="flex justify-content-between align-items-center">
                                <div class="w-2rem h-2rem border-round mr-2" style="background-color: var(--pink-400); box-shadow: 0px 0px 10px rgba(236, 77, 188, 0.3)"></div>
                                <span>India</span>
                            </div>
                            <span>10%</span>
                        </li>
                        <li class="flex justify-content-between align-items-center py-2 border-bottom-1 surface-border">
                            <div class="flex justify-content-between align-items-center">
                                <div class="w-2rem h-2rem border-round mr-2" style="background-color: var(--blue-400); box-shadow: 0px 0px 10px rgba(15, 139, 253, 0.3)"></div>
                        ...
                        <li class="flex justify-content-between align-items-center py-2 border-bottom-1 surface-border">
                            <div class="flex justify-content-between align-items-center">
                                <div class="w-2rem h-2rem border-round mr-2" style="background-color: var(--gray-400)"></div>
                                <span>Others</span>
                            </div>
                            <span>5%</span>
                        </li>
            ...
            <div class="card widget-table">
                ...
                <DataTable ref="dt" :value="customersTable" :selection="selectedCustomers1" dataKey="id" :rowHover="true" :rows="10" :paginator="true">
                    ...
                    <Column headerStyle="width: 8em" bodyStyle="text-align: center">
                        <template #body>
                            <Button text icon="pi pi-copy"></Button>
                            <Button text icon="pi pi-pencil"></Button>
                            <Button text icon="pi pi-ellipsis-h"></Button>
                        </template>
                    </Column>
                </DataTable>
            </div>
        ...
        <div class="col-12 md:col-4">
            <div class="card widget-performance">
                <div class="header line-height-4 font-medium">
                    ...
                    <p class="text-sm text-color-secondary">Top performances</p>
                </div>
                <div class="content">
                    <ul class="p-0 m-0 list-none">
                        <li class="py-3 px-0 flex align-items-center">
                            <Avatar image="/demo/images/ecommerce-dashboard/ann.png" v-badge="1" class="mr-2 w-3rem h-3rem" shape="circle"></Avatar>
                            <div class="ml-2">
                                <div class="text-xl text-color">$94,815</div>
                                <div class="text-sm text-color-secondary">Ann Vaccaro</div>
                            </div>
                        </li>
                        <li class="py-3 px-0 flex align-items-center">
                            <Avatar image="/demo/images/ecommerce-dashboard/miracle.png" v-badge="2" class="mr-2 w-3rem h-3rem" shape="circle"></Avatar>
                            <div class="ml-2">
                                <div class="text-xl text-color">$78,985</div>
                                <div class="text-sm text-color-secondary">Miracle Aminoff</div>
                            </div>
                        </li>
                        <li class="py-3 px-0 flex align-items-center">
                            <Avatar image="/demo/images/ecommerce-dashboard/kaylynn.png" v-badge="3" class="mr-2 w-3rem h-3rem" shape="circle"></Avatar>
                            <div class="ml-2">
                                <div class="text-xl text-color">$53,611</div>
                                <div class="text-sm text-color-secondary">Kaylynn Geidt</div>
                            </div>
                        </li>
                        <li class="py-3 px-0 flex align-items-center">
                            <Avatar image="/demo/images/ecommerce-dashboard/angel.png" v-badge="4" class="mr-2 w-3rem h-3rem" shape="circle"></Avatar>
                            <div class="ml-2">
                                <div class="text-xl text-color">$25,338</div>
                                <div class="text-sm text-color-secondary">Angel Rosser</div>
                            </div>
                        </li>
                        <li class="py-3 px-0 flex align-items-center">
                            <Avatar image="/demo/images/ecommerce-dashboard/cristofer.png" v-badge="5" class="mr-2 w-3rem h-3rem" shape="circle"></Avatar>
                            <div class="ml-2">
                                <div class="text-xl text-color">$15,989</div>
                                <div class="text-sm text-color-secondary">Cristofer Mango</div>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="col-12 lg:col-8">
            <div class="card widget-customer-graph">
                <div class="header">
                    ...
                    <p class="text-sm text-color-secondary">Number of new customer are listed by weekly</p>
                </div>
                ...
                <div class="content grid p-nogutter mt-3">
                    <div class="col-12 md:col-6 grid">
                        <div class="col-12 md:col-4 flex align-items-center">
                            ...
                            <p class="ml-2 text-color-secondary text-sm line-height-1">MAX</p>
                        </div>
                        <div class="col-12 md:col-4 flex align-items-center">
                            <h2 class="mb-0">{{ customerMin }}</h2>
                            <p class="ml-2 text-color-secondary text-sm line-height-1">MIN</p>
                        </div>
                        <div class="col-12 md:col-4 flex align-items-center">
                            <h2 class="mb-0" style="color: #fc6161">{{ customerAvg }}</h2>
                            <p class="ml-2 text-color-secondary text-sm line-height-1">AVARAGE</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 lg:col-4">
            <div class="card widget-target">
                ...
                <div class="content">
                    <h3 class="mt-3 mb-0">1232 Users</h3>
                    <span class="text-sm line-height-1 text-green-500">%3.5 <i class="pi pi-arrow-up text-sm"></i><span class="text-color-secondary"> than last week</span></span>
                </div>
                    ...
                    <div class="card mr-4">
                        <div class="customer-item-content text-center">
                            ...
                            <div>
                                ...
                                <h5 class="mt-0 mb-3 text-color-secondary">{{ slotProps.data.value }}</h5>
                            </div>
                        </div>
                    </div>
                </template>
